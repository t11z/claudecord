...
claude-discord is a **self-hosted** Discord bot. You run it — on a home
...
claude-discord talks to Claude (via the Claude Agent SDK). It will **not**
...
Prefer bare Node? See [Deployment](/claude-discord/guide/deployment/) for the
non-Docker path.
...
2. **Discord bot** — paste your bot token and application ID. Don't have one
   ...
   [Discord app setup](/claude-discord/guide/discord-app-setup/) — the one
...
- [Configuration](/claude-discord/guide/configuration/) — env vars, models, limits
- [Access control](/claude-discord/guide/access-control/) — who may talk to the bot, and the agentic mode switch
- [Troubleshooting](/claude-discord/guide/troubleshooting/) — when something doesn't work
